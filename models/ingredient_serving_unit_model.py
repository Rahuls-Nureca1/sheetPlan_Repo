...
class IngredientServingUnit( db.Model):
    ...
    serving_unit_othername = db.Column(db.String)
    serving_unit_quantity = db.Column(db.Integer)
    updated_by = db.Column(db.Integer)
    create_at = db.Column(db.DateTime, default=datetime.utcnow)
    updated_at = db.Column(db.DateTime, onupdate=datetime.utcnow)

    def __init__(self, serving_unit_name,serving_unit_othername, serving_unit_quantity,updated_by ) -> None:
        self.serving_unit_name = serving_unit_name
        self.serving_unit_othername = serving_unit_othername
